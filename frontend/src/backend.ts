...
export class Backend implements backendInterface {
    ...
    async getFarmerOrders(arg0: Principal): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFarmerOrders(arg0);
    ...
    async getFarmerProducts(arg0: Principal): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFarmerProducts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMarketplaceProducts(): Promise<Array<MarketplaceProduct>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerFarmer(arg0: FarmerProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerFarmer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        orderStatus: from_candid_OrderStatus_n13(_uploadFile, _downloadFile, value.orderStatus),
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        contactInfo: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.contactInfo)),
        farmLocation: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.farmLocation)),
        name: value.name
    };
}
...
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    farmer: null;
}): Variant_customer_farmer {
    return "customer" in value ? Variant_customer_farmer.customer : "farmer" in value ? Variant_customer_farmer.farmer : value;
}
...
function to_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        userType: to_candid_variant_n17(_uploadFile, _downloadFile, value.userType),
        contactInfo: value.contactInfo ? candid_some(value.contactInfo) : candid_none(),
        farmLocation: value.farmLocation ? candid_some(value.farmLocation) : candid_none(),
        name: value.name
    };
}
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_customer_farmer): {
    customer: null;
} | {
    farmer: null;
} {
    return value == Variant_customer_farmer.customer ? {
        customer: null
    } : value == Variant_customer_farmer.farmer ? {
        farmer: null
    } : value;
}
